...
const MONGO_URI = process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/ai4edu_database';
...
async function seed() {
  ...
  for (const worksheet of WORKSHEET_EXAMPLES) {
    ...
    console.log(`✓ Upserted worksheet: "${res.title}" (${res.educationLevel} - ${res.subjectArea})`);
  }
