/*
  ...
  Usage:
    ...
    3) From project root, run: node scripts/seed_worksheet_example.cjs
...
const MONGO_URI = "mongodb+srv://student_admin:stavanger25@clusterproject.5snil.mongodb.net/?retryWrites=true&w=majority&appName=ClusterProject";

if (!MONGO_URI) {
  console.error('❌ Error: MONGO_URI environment variable is not set.');
  console.error('\n📝 Please set MONGO_URI before running the script:');
  console.error('   Windows PowerShell: $env:MONGO_URI="mongodb://127.0.0.1:27017/ai4edu_database"');
  console.error('   Windows CMD: set MONGO_URI=mongodb://127.0.0.1:27017/ai4edu_database');
  console.error('   Linux/Mac: export MONGO_URI="mongodb://127.0.0.1:27017/ai4edu_database"');
  console.error('\n💡 Example MongoDB URIs:');
  console.error('   Local: mongodb://127.0.0.1:27017/ai4edu_database');
  console.error('   Atlas: mongodb+srv://username:password@cluster.mongodb.net/ai4edu_database');
  process.exit(1);
}
...
const worksheetSchema = new mongoose.Schema(
  {
    ...
    education_level: { type: String, required: true, enum: ['elementary', 'high-school', 'higher-education'] },
...
const WORKSHEET_EXAMPLES = [
    {
      ...
      "format_description": "Picture-word matching, short reading tasks, copying words, completing simple sentences.",
      "examples": [
    ...
    },
    {
      ...
      "format_description": "Word recognition, image-supported reading, fill-in-the-blank.",
      "examples": [
    ...
    },
    {
      ...
      "format_description": "Counting tasks, simple addition/subtraction, shape identification.",
      "examples": [
    ...
    },
    {
      ...
      "format_description": "Picture naming, repeat-after-me tasks, matching basic vocabulary.",
      "examples": [
    ...
    },
    {
      ...
      "format_description": "Picture-based classification, simple observations, matching tasks.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Picture discussions, very short responses, matching roles and places.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Image comparison, timeline with 2–3 steps, simple questions.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Reflection on activities, rule identification, sorting tasks.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Listening tasks, rhythm imitation, simple emotional response.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Short texts with questions, sentence construction, vocabulary tasks.",
      "examples": [
    ...
    },
    {
      ...
      "format_description": "Reading tasks with images, fill-in-the-blank, vocabulary matching.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Two-step problems, number sequences, simple bar illustrations.",
      "examples": [
        "42 − 18 = ?",
  ...
  
    {
      ...
      "format_description": "Short reading tasks, picture descriptions, simple grammar tasks.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Sorting tasks, simple explanations, observation-based questions.",
      "examples": [
  ...
  
    {
      ...
      "format_description": "Timeline with 3–4 steps, image interpretation, short questions.",
      "examples": [
...

  {
    ...
    "format_description": "Short reading texts, comprehension questions, 3–5 sentence writing tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Short texts, vocabulary tasks, fill-the-gaps, simple writing.",
    "examples": [
...

  {
    ...
    "format_description": "Word problems, number patterns, multi-digit operations.",
    "examples": [
      "345 − 128 = ?",
      "Hva er 4 × 6?",
...

  {
    ...
    "format_description": "Short texts, picture descriptions, fill-in grammar tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Classification tasks, simple explanations, experiment observations.",
    "examples": [
...

  {
    ...
    "format_description": "Timelines, picture comparisons, simple source analysis.",
    "examples": [
...

  {
    ...
    "format_description": "Reflection prompts, rule explanations, body awareness tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Listening tasks, rhythm imitation, descriptive questions.",
    "examples": [
...

  {
    ...
    "format_description": "Paragraph writing, comprehension questions, vocabulary tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Text-based questions, grammar tasks, sentence writing.",
    "examples": [
...

  {
    ...
    "format_description": "Multi-step problems, graph reading, multiplication/division.",
    "examples": [
      "Hva er 8 × 7?",
...

  {
    ...
    "format_description": "Food chain diagrams, observation logs, explanation tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Timeline building, source interpretation, comparison tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Short reflections, rule tasks, training concept questions.",
    "examples": [
...

  {
    ...
    "format_description": "Listening analysis, rhythm creation, style comparison.",
    "examples": [
...

  {
    ...
    "format_description": "Food classification, recipe tasks, health reflections.",
    "examples": [
...

  {
    ...
    "format_description": "Word problems, fractions tasks, diagram interpretation.",
    "examples": [
      "Hva er 1/2 av 24?",
      "Skriv 0.6 som brøk.",
...

  {
    ...
    "format_description": "Labeling diagrams, explanation tasks, experiment logs.",
    "examples": [
...

  {
    ...
    "format_description": "Reflection writing, skill explanation, training planning.",
    "examples": [
...

  {
    ...
    "format_description": "Longer text analysis, multi-paragraph writing, argumentation.",
    "examples": [
...

  {
    ...
    "format_description": "Fractions/per cent tasks, coordinate grids, applied problems.",
    "examples": [
      "Hva er 25% av 160?",
...

  {
    ...
    "format_description": "Longer reading tasks, structured writing, grammar practice.",
    "examples": [
...

  {
    ...
    "format_description": "Map tasks, global issue questions, cause–effect charts.",
    "examples": [
      "Hva betyr bærekraft?",
...

  {
    ...
    "format_description": "Training reflections, technique descriptions, activity logs.",
    "examples": [
...

  {
    ...
    "format_description": "Technique tasks, design analysis, project reflections.",
    "examples": [
  ...
  /* ================================
    ...
    "format_description": "Deep text analysis, structured writing, argumentation tasks.",
    "examples": [
    ...
    "format_description": "Reading comprehension, grammar tasks, structured writing.",
    "examples": [
    ...
    "format_description": "Applied maths problems, graphs, multi-step calculation.",
    "examples": [
    ...
    "format_description": "Scientific method tasks, diagrams, explanation activities.",
    "examples": [
    ...
    "format_description": "Source evaluation, timeline tasks, comparative writing.",
    "examples": [
    ...
    "format_description": "Training logs, performance reflections, planning tasks.",
    "examples": [
    ...
    "format_description": "Meal planning, nutrition evaluations, sustainability tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Short reading texts, comprehension tasks, vocabulary activities, paragraph writing.",
    "examples": [
...

  {
    ...
    "format_description": "Algebra tasks, function interpretation, multi-step reasoning problems.",
    "examples": [
...

  {
    ...
    "format_description": "Source tasks, timeline building, cause–effect questions.",
    "examples": [
...

  {
    "education_level": "high-school",
    "year": "Year 1 (VG1)",
    "subject": "General Study Programmes (Sports, Art, Media, Music, Dance, Drama)",
    "learning_objectives": [
    ...
    "format_description": "Reflection notes, technique descriptions, simple project tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Short reflection tasks, basic analysis, structured note-taking.",
    "examples": [
...

  {
    ...
    "format_description": "Literary analysis, argument writing, structured discussion questions.",
    "examples": [
...

  {
    ...
    "format_description": "Function analysis, equation solving, applied statistics tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Analytical essays, source comparison, cause–effect chains.",
    "examples": [
...

  {
    ...
    "format_description": "Technique analysis, performance review, reflection logs.",
    "examples": [
...

  {
    ...
    "format_description": "Short essays, comparison tasks, structured discussions.",
    "examples": [
...

  {
    ...
    "format_description": "Advanced text analysis, essay writing, discourse interpretation.",
    "examples": [
...

  {
    ...
    "format_description": "Modeling tasks, trigonometry problems, applied statistics.",
    "examples": [
...

  {
    ...
    "format_description": "Advanced source analysis, argumentative essays, timeline synthesis.",
    "examples": [
...

  {
    ...
    "format_description": "Advanced project tasks, performance analysis, portfolio reflections.",
    "examples": [
...

  {
    ...
    "format_description": "Extended reflective writing, interdisciplinary analysis, presentation tasks.",
    "examples": [
...

  {
    ...
    "year": "Year 1",
    "subject": "Arts, Humanities, and Social Sciences - Arts (Art, Design, Architecture, Music, Dance, Drama)",
    "learning_objectives": [
    ...
    "format_description": "Introductory analysis tasks, visual/performative reflection prompts, terminology exercises.",
    "examples": [
...

  {
    "education_level": "higher-education",
    "year": "Year 1",
    "subject": "Arts, Humanities, and Social Sciences - Humanities (Languages and Literature, History, Philosophy)",
    "learning_objectives": [
    ...
    "format_description": "Short text analyses, source interpretation, academic writing basics.",
    "examples": [
...

  {
    "education_level": "higher-education",
    "year": "Year 1",
    "subject": "Arts, Humanities, and Social Sciences - Social Sciences (Economics, Psychology, Sociology, Political Science, Social Anthropology)",
    "learning_objectives": [
    ...
    "format_description": "Concept-definition tasks, introductory case analysis, simple data interpretation.",
    "examples": [
...

  {
    ...
    "format_description": "Media analysis tasks, short reflection, communication-model exercises.",
    "examples": [
...

  {
    ...
    "format_description": "Introductory calculation tasks, diagram interpretation, simple design reasoning.",
    "examples": [
...

  {
    "education_level": "higher-education",
    "year": "Year 1",
    "subject": "STEM and Technology - ICT (Computer Science, IT, Information Systems)",
    "learning_objectives": [
    ...
    "format_description": "Pseudocode tasks, simple coding exercises, conceptual IS questions.",
    "examples": [
...

  {
    "education_level": "higher-education",
    "year": "Year 1",
    "subject": "STEM and Technology - Natural Sciences (Biology, Chemistry, Physics, Mathematics)",
    "learning_objectives": [
    ...
    "format_description": "Intro-level calculations, concept explanations, diagram labeling.",
    "examples": [
...

  {
    ...
    "format_description": "Terminology tasks, basic scenario analysis, safety-procedure questions.",
    "examples": [
...

  {
    ...
    "format_description": "Concept-definition tasks, simple case analysis, experiment interpretation.",
    "examples": [
...

  {
    ...
    "format_description": "Short case studies, graph interpretation, basic calculations.",
    "examples": [
...

  {
    ...
    "format_description": "Introductory case evaluation, species–environment diagrams, sustainability questions.",
    "examples": [
...

  {
    ...
    "format_description": "Short reflections, scenario questions, introductory theory tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Customer-scenario analysis, short reflections, service-model tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Chart-interpretation tasks, safety-procedure questions, terminology exercises.",
    "examples": [
...

  {
    ...
    "format_description": "Cross-disciplinary writing, academic reading tasks, reflection.",
    "examples": [
 ...
 /* ==========================
     ...
     ========================== */
     {
        ...
        "format_description": "Critical analysis tasks, concept development exercises, structured reflection.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Text interpretation, comparative essays, theory-application tasks.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Case analysis, data interpretation tasks, theory-application questions.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Media-text analysis, communication-model application, case-based questions.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Technical calculations, applied problem solving, design evaluation tasks.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Coding tasks, database queries, system architecture diagrams.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Problem-solving tasks, lab report components, data analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Scenario-based analysis, clinical reasoning questions, terminology application.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Case analysis, theory comparison, research interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Case studies, financial interpretation, short strategic analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "System analysis, sustainability evaluation, ecological interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Scenario discussion, theory application, strategy evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Case-based service analysis, tourism-economy questions, improvement proposals.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Navigation tasks, safety-case analysis, performance-data interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Cross-disciplinary analysis, academic writing tasks, argument evaluation.",
        "examples": [
 ...
 /* ==========================
     ...
     ========================== */
     {
        ...
        "format_description": "Advanced analysis, creative project planning, critique writing.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Comparative analysis, argument evaluation, multi-source writing.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Case-based analysis, empirical interpretation, theory–practice application.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Theory application, media comparison, ethics evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "System calculations, engineering-economy evaluation, diagnostic tasks.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Software design tasks, performance evaluation, architecture reasoning.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Quantitative problem-solving, experiment evaluation, model application.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Clinical scenario interpretation, intervention justification, case reasoning.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced case analysis, theory comparison, data interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Financial interpretation, strategic reasoning, model-based analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Data interpretation, ecological impact analysis, trade-off evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Classroom analysis, mini-lesson design, theory evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Service-quality analysis, tourism-model application, improvement proposals.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Risk assessment, navigation tasks, performance analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Cross-disciplinary synthesis, argument critique, analytical writing.",
        "examples": [
     ...
     ========================== */
     {
        ...
        "format_description": "Advanced theoretical analysis, project planning, reflective critique.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Multi-theory text analysis, comparative argumentation, source-based writing.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Theory application, critical data evaluation, cause–effect analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "In-depth media analysis, ethics evaluation, strategy design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "System modeling, engineering-economics evaluation, technical analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Architecture design, performance evaluation, system trade-off analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Dataset analysis, model-based reasoning, experiment evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Clinical reasoning, intervention evaluation, case-based assessment.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Theory evaluation, layered case analysis, data interpretation tasks.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Strategic analysis, financial evaluation, model application.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Ecological impact analysis, model-based evaluation, sustainability assessment.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Lesson design, instructional analysis, pedagogical evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Service-design analysis, market evaluation, model application.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Risk analysis, navigation evaluation, data interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Cross-disciplinary synthesis, argument critique, advanced analytical writing.",
        "examples": [
     ...
     ========================== */
     {
        ...
        "format_description": "Advanced theoretical analysis, creative project documentation, scholarly critique.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced comparative writing, multi-theory synthesis, long-form academic analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Policy analysis, empirical evaluation, theory-driven case analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Strategic communication design, media ethics evaluation, complex analysis tasks.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "System modeling, engineering justification, technical feasibility analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Architecture evaluation, system optimization, justification of technological decisions.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Complex data interpretation, experiment design, model-based reasoning.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced case analysis, intervention evaluation, clinical synthesis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Multi-theory analysis, statistical interpretation, intervention evaluation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Strategic evaluation, financial interpretation, long-term decision-making.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced sustainability analysis, risk assessment, dataset interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Module design, advanced theory application, classroom interaction analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Trend analysis, system evaluation, evidence-based improvement design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Risk modeling, navigation analysis, operational dataset interpretation.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Cross-disciplinary analysis, argument critique, extended essay writing.",
        "examples": [
     ...
     ========================== */
{
    ...
    "format_description": "Theoretical analysis, advanced project planning, scholarly critique writing.",
    "examples": [
...

  {
    ...
    "format_description": "Advanced textual exegesis, comparative theoretical writing, structured academic essays.",
    "examples": [
...

  {
    ...
    "format_description": "Theory-driven analysis, methodological evaluation, research design tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Advanced media analysis, ethical reasoning tasks, research-based strategy design.",
    "examples": [
...

  {
    ...
    "format_description": "Complex system modeling, technical analysis, evidence-based justification.",
    "examples": [
...

  {
    ...
    "format_description": "Architecture design, empirical evaluation, design rationale tasks.",
    "examples": [
...

  {
    ...
    "format_description": "Theoretical modeling, experiment evaluation, advanced data interpretation.",
    "examples": [
...

  {
    ...
    "format_description": "Complex clinical case evaluation, intervention justification, integrated assessment.",
    "examples": [
...

  {
    ...
    "format_description": "Advanced case analysis, research critique, intervention design.",
    "examples": [
...

  {
    ...
    "format_description": "Strategic evaluation, financial analysis, research-based decision-making.",
    "examples": [
...

  {
    ...
    "format_description": "Sustainability analysis, dataset interpretation, system-level strategy design.",
    "examples": [
...

  {
    ...
    "format_description": "Pedagogical evaluation, instructional design, research critique.",
    "examples": [
...

  {
    ...
    "format_description": "Market analysis, service innovation design, data-driven evaluation.",
    "examples": [
...

  {
    ...
    "format_description": "Multi-factor risk analysis, operational evaluation, improvement proposals.",
    "examples": [
...

  {
    ...
    "format_description": "Interdisciplinary synthesis, advanced critique, research-based writing.",
    "examples": [
 ...
 /* ==========================
     ...
     ========================== */
     {
        ...
        "format_description": "Research-level critique, theoretical synthesis, original artistic research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced theoretical synthesis, critique writing, publication-level analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Theory-driven critique, methodological analysis, research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Research-level analysis, ethics and power critique, original research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced modeling, critical technical evaluation, original system design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Research-level architecture analysis, empirical performance evaluation, original research tasks.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Theoretical modeling, research critique, advanced data analysis.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced case evaluation, research critique, clinical research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "High-level theory integration, research critique, experimental design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced model critique, theoretical evaluation, original research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Advanced ecological modeling, sustainability critique, research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Intervention analysis, research critique, educational research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Large-scale data analysis, theoretical evaluation, research design.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "System-level maritime analysis, model critique, research planning.",
        "examples": [
    ...
    
      {
        ...
        "format_description": "Interdisciplinary synthesis, advanced theoretical critique, original research design.",
        "examples": [
...
async function seed() {
  if (WORKSHEET_EXAMPLES.length === 0) {
    console.log('⚠️  No worksheet examples found. Please add your JSON data to the WORKSHEET_EXAMPLES array.');
    process.exit(0);
  }

  console.log(`Connecting to: ${MONGO_URI}`);
  console.log('💡 Tip: If MongoDB is not running, start it with: mongod');
  console.log('   Or set MONGO_URI environment variable to your MongoDB connection string');
  
  try {
    await mongoose.connect(MONGO_URI, { 
      dbName: 'ai4edu_database',
    ...
    if (error.name === 'MongooseServerSelectionError') {
      ...
      console.error('   3. Set MONGO_URI environment variable:');
      console.error('      Windows: $env:MONGO_URI="mongodb://your-host:27017/ai4edu_database"');
      console.error('      Linux/Mac: export MONGO_URI="mongodb://your-host:27017/ai4edu_database"');
      console.error('   4. Use MongoDB Atlas or remote MongoDB connection string');
    }
    throw error;
  }
  ...
  for (let i = 0; i < WORKSHEET_EXAMPLES.length; i++) {
    const worksheet = WORKSHEET_EXAMPLES[i];
    
    try {
      // Automatically generate sequential template_id for each worksheet
      // Format: TID00001, TID00002, TID00003, etc.
      const templateIdNumber = i + 1;
      worksheet.template_id = `TID${String(templateIdNumber).padStart(5, '0')}`;

      // Use template_id as unique identifier
      const uniqueKey = { template_id: worksheet.template_id };
      ...
      const update = {
        ...
        learning_objectives: worksheet.learning_objectives,
        format_description: worksheet.format_description || '',
      ...
      successCount++;
      console.log(`✓ [${i + 1}/${WORKSHEET_EXAMPLES.length}] Upserted: "${res.title}" (${res.educationLevel} - ${res.subjectArea})`);
    } catch (error) {
      errorCount++;
      console.error(`❌ [${i + 1}/${WORKSHEET_EXAMPLES.length}] Error processing worksheet:`, error.message);
      if (worksheet.title) {
        console.error(`   Title: "${worksheet.title}"`);
      }
    }
  }
